...
// components
import { Page, ErrorScreen, HomeModal } from '../src/components';
// sections
...
export default function ElearningLandingPage({ posts }) {
  ...
  const { data: siteContent = [], error2 } = useRequest({
    url: `/api/contents`,
  });
  ...
  return (
    <Page title="Home">
      <HomeModal />
      <RootStyle>
        <ElearningLandingHero siteContent={siteContent} />
        ...
        {/* <TestimonialsElearning testimonials={feedbacks} /> */}
