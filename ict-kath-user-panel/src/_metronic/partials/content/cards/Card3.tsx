...
const Card3: FC<Props> = ({
  ...
  return (
    <div className='card' style={{ maxHeight: '500px', minHeight: '500px' }}>
      <div className='card-body d-flex flex-center flex-column p-9'>
        ...
        <div className='d-flex flex-center flex-wrap mb-5'>
          ...
          <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 mx-3 px-4 mb-3'>
            <div className='fs-6 fw-bolder text-gray-700'>{class_date} - {avgEarnings}</div>
            <div className='fw-bold text-gray-400'>Date - Time</div>
          </div>
        </div>

        <div className='d-flex flex-center flex-wrap mb-5'>
          <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mx-3 mb-3'>
            <div className='fs-6 fw-bolder text-gray-700' style={{ textTransform: 'capitalize' }}>{language}</div>
            <div className='fw-bold text-gray-400'>Language</div>
          </div>

          <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 mx-3 px-4 mb-3'>
            <div className='fs-6 fw-bolder text-gray-700' >{totalEarnings}</div>
            <div className='fw-bold text-gray-400'>Class Fee</div>
          </div>
        </div>
